...
namespace Joker2X.Localize.Scripts.Editor
{
    public class LocalizeParse
    {
        public void Parse(string data)
        {
            ...
            for (int i = engine.Options.FieldCount - 1; i >= 0; i--)
            {
                ...
                if (string.CompareOrdinal("KEY_lang", fieldsName) != 0 /*&& string.CompareOrdinal("English", fieldsName) != 0*/)
                {
    ...
    public class LanguageCSVFormat
    {
        ...
        [FieldOrder(17)]
        [FieldConverter(typeof(LanguageConverter))]
        ...
        public void FillEmptyField()
        {
            ...
            if (string.IsNullOrEmpty(Turkish)) Unknown = English;
            if (string.IsNullOrEmpty(Hindi)) Hindi = English;
        }
    }
