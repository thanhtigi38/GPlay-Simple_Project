...
public class ConfigBuild
{
    ...
    private static string KeyStorePath = "Assets/KeyStore/perfecttidyasmrmaker.keystore";

    private const string folderPath = "FindCat_Final";
    ...
    [MenuItem("Open Scene/Jigsaw Game Play #4")]
    public static void OpenSceneJigsawGamePlay()
    {
        string localPath = "Assets/00GAME/Scenes/TEST.unity";
        EditorSceneManager.SaveCurrentModifiedScenesIfUserWantsTo();
        EditorSceneManager.OpenScene(localPath);
    }
