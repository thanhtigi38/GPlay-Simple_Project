...
public class Config
{
    public static string settingProductName = "Perfect Tidy ASMR Maker";

    public const string settingKeyStore = "perfecttidyasmrmaker";
    public static string keyaliasPass = "12345678two";
    public static string keystorePass = "12345678two";
    public static string settingAliasName = "perfecttidyasmrmaker";

    public const string settingLogo = "GAME_ICON";

    public static int versionCode = 2026020301;//sua
    public static string versionName = "1.0.5";//sua
    public static int settingVersionCode = 2026020301;//sua
    public static string settingVersionName = "1.0.5";//sua

    public static string productNameBuild = "Perfect Tidy ASMR Maker";
...
#if UNITY_ANDROID
    public const string package_name = "com.gplay.perfect.tidy.asmr.maker";
#else
    public const string package_name = "com.gplay.perfect.tidy.asmr.maker";
#endif
