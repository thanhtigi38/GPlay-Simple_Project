...
public class MoneyEffect : MonoBehaviour
{
    ...
    public void SetUpMoveCome(Vector3 posCome, Item itemType, int value, UnityAction actionCome, bool isFollowObject = false, GameObject objectFollow = null)
    {
        ...
        childObj.DOScale(1, 0.3f).SetEase(Ease.OutBack).SetUpdate(true).OnComplete(() =>
        {
            ...
            childObj.DOMove(posCome, 1f).SetUpdate(true).SetEase(Ease.InBack).OnComplete(() =>
            {
    ...
    public void SetSpriteIcon(Item itemType)
    {
    ...
    public void SetMoveFlyUp(Item itemType, string value, Color colorText, bool isFollowObject = false, GameObject objectFollow = null)
    {
    ...
    public void SetMoveFlyUpCoinPlayer(Item itemType, string value, Color colorText, bool isFollowObject = false, GameObject objectFollow = null)
    {
        addValueTxt.gameObject.SetActive(true);
        iconItem.gameObject.SetActive(true);
        textContent.gameObject.SetActive(false);
