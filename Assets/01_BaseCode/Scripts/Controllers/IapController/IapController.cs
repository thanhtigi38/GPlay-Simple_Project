...
public class IapController : MonoBehaviour, IStoreListener
{
    ...
    public void Init()
    {
        ...
        for (int i = 0; i < inappDatabase.lstPacksInapp.Count; i++)
        {
            ...
            builder.AddProduct(pack.ProductID, pack.productType, new StoreSpecificIds()
                {
            ...
            if (pack.isSale)
            {
                builder.AddProduct(pack.ProductID_Origin, pack.productType, new StoreSpecificIds
                {
	...
	public PurchaseProcessingResult ProcessPurchase(PurchaseEventArgs purchaseEvent)
    {
        ...
        //if(e == null)
        Debug.Log("HOANG===============  " + purchaseEvent.purchasedProduct.definition.id);
        //m_LastTransationID = e.purchasedProduct.transactionID;
        //m_LastReceipt = e.purchasedProduct.receipt;
        //m_PurchaseInProgress = false;

        ProcessPurchaseSuccess(purchaseEvent);
    ...
    public void RestorePurchases()
    {
            ...
            Application.platform == RuntimePlatform.OSXPlayer)
        {
            ...
            apple.RestoreTransactions((result, mess) =>
            {
